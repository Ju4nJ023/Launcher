...
public class Embarquee extends javax.swing.JFrame {
 ...
 int contador=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Embarquee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
