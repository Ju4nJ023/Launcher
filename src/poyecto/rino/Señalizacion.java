...
public class Señalizacion extends javax.swing.JFrame {
 ...
 int contador=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Señalizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Señalizacion().setVisible(true);
            }
        });
    }
