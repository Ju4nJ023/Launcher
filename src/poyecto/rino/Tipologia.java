...
public class Tipologia extends javax.swing.JFrame {
 ...
 int contador=0;
    public Tipologia() {
        ...
        for(int a=0;a<5;a++){
            Imagen[a]=new ImageIcon(getClass().getResource("/imagesGame/EPIS"+a+".png"));
...
public String Descripcion = 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tipologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
