...
public class _protocolo extends javax.swing.JFrame {
 ...
 int contador=0;
    public _protocolo() {
        ...
        for(int a=0;a<5;a++){
            Imagen[a]=new ImageIcon(getClass().getResource("/imagesGame/Hemorragia"+a+".png"));
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Protocolo ante una hemorragia externa");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _protocolo().setVisible(true);
            }
        });
    }
